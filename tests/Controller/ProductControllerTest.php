...
class ProductControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'product[qty_available]' => 'Testing',
            'product[qty_total]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        ...
        $fixture->setQty_available('My Title');
        $fixture->setQty_total('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'product[qty_available]' => 'Something New',
            'product[qty_total]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getQty_available());
        self::assertSame('Something New', $fixture[0]->getQty_total());
    }
